...
class GrammarDAO {
  ...
  final List<dynamic> eg;

  GrammarDAO(
      {this.id, this.note, this.title,this.chapter, this.myanmar, this.hiragana, this.eg});

  GrammarDAO.fromSnapshot(DocumentSnapshot snapshot)
      : note = snapshot.data['note'],
        ...
        eg = snapshot.data['examples'];

  GrammarDAO.fromMap(Map<String, dynamic> map)
      : note = map['note'],
        id = map['id'],
        isFav = map['isFav'],
        chapter = map['chapter'],
